  ...
  if (loading) {
    return (
      <div className="luxury-card p-8 text-center">
        ...
        <p className="mt-4 text-slate-600">Loading star reports...</p>
      </div>
    );
  }
    ...
    return (
      <div className="luxury-card p-8 text-center">
        ...
        <p className="text-slate-600">
          Please log in to access your star reports.
        </p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      <div className="luxury-card p-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h2 className="text-2xl font-bold text-slate-800">Star Reports</h2>
            <p className="text-slate-600">
              Access your star reports and property performance metrics
            </p>
          </div>
      ...
      <div className="luxury-card">
        {documentsLoading ? (
          ...
          <div className="p-8 text-center">
            <div className="text-slate-400 text-6xl mb-4">⭐</div>
            <h3 className="text-lg font-semibold text-slate-800 mb-2">
              No Star Reports Found
            </h3>
            <p className="text-slate-600">
              {selectedPropertyId
                ? "No star reports available for the selected property."
                : "No star reports have been uploaded yet."}
            </p>
          </div>
        ) : (
