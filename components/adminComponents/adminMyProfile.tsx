    ...
    <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="flex items-center">
                  <p className="text-slate-900 mr-2">Administrator</p>
      ...
      <div className="luxury-card p-8">
        ...
        {isChangingPassword ? (
          ...
          <div>
            <p className="text-slate-600">
              Click "Change Password" to update your administrator account
              password. You'll need to provide your current password for
              security.
            </p>
          </div>
        )}
